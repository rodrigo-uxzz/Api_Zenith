...
<title>Conta aprovada - Zenith</title>
</head>
      ...
      <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:20px; overflow:hidden; box-shadow:0 8px 40px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td align="center" style="padding:8px 40px 0;">
            <p style="margin:0; font-size:15px; color:#555555; line-height:1.6;">
              Parabéns! Sua conta foi <strong style="color:#A383FB;">aprovada</strong>.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td align="center" style="padding:8px 40px 32px;">
            <p style="margin:0; font-size:15px; color:#555555; line-height:1.6;">
              Você já pode acessar o sistema Zenith e começar a gerenciar seus atendimentos.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td align="center" style="padding:0 40px 40px;">
            <a href="#" style="display:inline-block; background-color:#A383FB; color:#ffffff; text-decoration:none; font-size:15px; font-weight:600; padding:14px 36px; border-radius:14px;">
              Acessar o Zenith
            </a>
          </td>
        </tr>
