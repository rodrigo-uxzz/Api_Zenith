...
<title>Conta não aprovada - Zenith</title>
</head>
      ...
      <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:20px; overflow:hidden; box-shadow:0 8px 40px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td align="center" style="padding:32px 40px 0;">
            <table role="presentation" cellpadding="0" cellspacing="0">
              <tr>
                <td width="64" height="64" align="center" valign="middle" style="background-color:#ffe9e9; border-radius:50%; font-size:28px; color:#ff7d7d; font-weight:700;">
                  &#10005;
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td align="center" style="padding:8px 40px 0;">
            <p style="margin:0; font-size:15px; color:#555555; line-height:1.6;">
              Infelizmente sua conta <strong style="color:#ff7d7d;">não foi aprovada</strong>.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td align="center" style="padding:8px 40px 32px;">
            <p style="margin:0; font-size:15px; color:#555555; line-height:1.6;">
              Entre em contato com nossa equipe para mais informações sobre os próximos passos.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td align="center" style="padding:0 40px 40px;">
            <span style="display:inline-block; background-color:#ffe9e9; color:#ff7d7d; font-size:13px; font-weight:600; padding:10px 24px; border-radius:999px;">
              Status: não aprovada
            </span>
          </td>
        </tr>
